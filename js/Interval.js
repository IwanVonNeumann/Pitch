...
Interval.prototype = 
{
  ...
  setTimeout(function(){intervalPlaySound(tone1)}, 1000);
  },

  randomOfTwo: function(diff0, diff1)
  {
    tone_ind = RandomUtil.getMod(2);
  ...
  randomInterval: function(level)
  {
    ...
    num_intervals = Math.min(level + 2, Constants.intervals.length);
    interval_ind = RandomUtil.getMod(num_intervals);
