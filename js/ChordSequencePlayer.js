...
var ChordSequencePlayer =
{
  ...
  playSequence: function(i_sequence)
  {
    ...
    var func= function() { if(seq.length == 0) return; sequencePlayChord(seq[0]); seq = seq.slice(1, seq.length);}
    ...
    setTimeout(function(){ChordSequencePlayer.playing = false;}, seq.length*611);
  }
}
