var Constants = {
    ...
    init: function () {
        ...
        this.tone_names = ["C", "C\u266F", "D", "E\u266D", "E", "F", "F\u266F", "G", "G\u266F", "A", "B\u266D", "B"];
    ...
    toneNameInKey: function (tone, key, major) {
        ...
        //flat tonality
        return this.toneName(corrected + 1) + "\u266D";
    },

    longToneNameInKey: function (tone, key, major) {
        return this.toneNameInKey(tone, key, major) + (Math.floor(tone / 12) + 1).toString();
    }
};
